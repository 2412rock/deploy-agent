...
def post_data():
    ...
    f = open('C:/Users/Adi/Documents/password.txt', 'r')
    password = f.readline()
...
def deploy_frontend():
    os.chdir("C:/Users/Adi/Desktop")
    os.system("git clone https://github.com/2412rock/Dorel-angular")
    os.chdir("C:/Users/Adi/Desktop/Dorel-angular")
...
def deploy_backend():
    ...
    os.chdir("C:/Users/Adi/Desktop/Dorel-backend")
